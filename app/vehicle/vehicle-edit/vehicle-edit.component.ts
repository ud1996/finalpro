...
export class VehicleEditComponent implements OnInit {
 ...
 formSubmitted: boolean = false;
  ...
  ngOnInit() {
    ...
    .subscribe((v:Vehicle)=>{
      ...
      this.editForm = new FormGroup({
        ...
        'veInsuaranceExpiryDate':new FormControl(null,Validators.required),
     ...
     if(this.vehicle){
       ...
       this.editForm.patchValue({
         ...
         veInsuaranceExpiryDate:this.vehicle.veInsuranceExpiryDate,
  ...
  onEditForm(){
    ...
    let veInsuaranceExpiryDate=this.editForm.get('veInsuaranceExpiryDate').value;
    ...
    let veServiceDueDate=this.editForm.get('veServiceDueDate').value;
     ...
     this.updatedVehicle = {veId:veId,price:price,veType:veType,veInsuaranceExpiryDate:veInsuaranceExpiryDate,velastServiceDate:velastServiceDate,veName:veName,imageUrl:imageUrl,veServiceDueDate:veServiceDueDate,veAvailability:"avaialable"}
